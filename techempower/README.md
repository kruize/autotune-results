...
```
[Quarkus Layer]   quarkus.thread-pool.core-threads [1]       - This number of threads will always be kept alive.
...
[Hotspot Layer]   maxinlinelevel [9]                         - Maximum number of nested calls that are inlined.
